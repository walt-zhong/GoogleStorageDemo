...
package com.zhongxj.mediastore
...
import com.zhongxj.mediastore.databinding.ActivityMainBinding
import com.zhongxj.permissions.OnPermissionCallback
import com.zhongxj.permissions.XXPermissions
...
//            ActivityCompat.requestPermissions(this, permissions, READ_EXTERNAL_STORAGE_REQUEST)
            ...
            XXPermissions.with(this).permission(permissions).request { permissions, _ ->
                Log.d("zhongxj","permissions: ${permissions.size}")
                showImages()
            }
        }
    }
