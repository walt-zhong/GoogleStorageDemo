...
package com.zhongxj.scopedstorage.common
    ...
    Card(
        ...
        Column {
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                resource.filename?.let { Text(text = it, style = MaterialTheme.typography.subtitle2) }
...
fun DocumentFilePreviewCard(resource: FileResource) {
    ...
    val thumbnail by produceState<Bitmap?>(null, resource.uri) {
        value = resource.uri?.let { SafUtils.getThumbnail(context, it) }
    }
