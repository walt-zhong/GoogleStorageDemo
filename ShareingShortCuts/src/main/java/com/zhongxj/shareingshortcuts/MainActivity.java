...
package com.zhongxj.shareingshortcuts;
...
public class MainActivity extends Activity {
    ...
    private static final String FILE_PROVIDER_AUTHORITY =
            "com.zhongxj.shareingshortcuts.fileprovider";
    ...
    private Uri saveImageThumbnail() throws IOException {
        Bitmap bm = BitmapFactory.decodeResource(getResources(), R.mipmap.logo_avatar
        );
        File cachePath = new File(getFilesDir(), IMAGE_CACHE_DIR);
        cachePath.mkdirs();
        Log.d("zhongxj","cachePath is exist: " + cachePath.exists()
        + " ,can read: " + cachePath.canRead() + " ,can write: " + cachePath.canWrite());
